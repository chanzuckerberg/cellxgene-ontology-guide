...
ROOT_DIR = os.path.realpath(__file__).rsplit("/", maxsplit=4)[0]
SCHEMA_DIR = os.path.join(ROOT_DIR, "artifact-schemas")
ONTOLOGY_ASSETS_DIR = os.path.join(ROOT_DIR, "ontology-assets")
